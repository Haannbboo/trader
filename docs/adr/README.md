...
This directory contains records of critical design choices and architectural decisions for the `trader` platform.
...
* [ADR-0003: Persistence Read Face](0003-persistence-read-face.md)
